...
# f5
sheared_figure = f5_shear_figure(fig_1, 'x', 15)
...
test_image = cv2.imread('C:/Users/MB_6489/Desktop/building.jpg')
plot_figure_with_opencv(reflect_image_opencv(rotate_image_opencv(test_image, 45), 'y'))
